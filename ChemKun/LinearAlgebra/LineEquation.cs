    ...
    public class LineEquation
    {
		...
		public static void gaussj(ref double[] a, int n, ref double[] b)
        {
            ...
            for (i = 0; i <= n - 1; i++)
            {
                    ...
                    if (ipiv[j] != 1)
                    {
                        for (k = 0; k <= n - 1; k++)
                        {
                            if (ipiv[k] == 0)
                            {
                                ...
                                {
                                    Output.WriteOutput.Error.Append("ChemKun.MECP.Opter.LagrangeNewton_Zmatrix.CalGaussJordan died. Error. singular matrix in gaussj process. :: Site 1" + "/n");
                ...
                {
                    Output.WriteOutput.Error.Append("ChemKun.MECP.Opter.LagrangeNewton_Zmatrix.CalGaussJordan died. Error. singular matrix in gaussj process. :: Site 2" + "/n");
