...
{
    partial class LagrangeNewton_Zmatrix
    {
        public LagrangeNewton_Zmatrix(Data_Input data_Input, ref Data_MECP data_MECP)
        {
            //初始化
            try
            {
        ...
        {
            //给Lambda赋值
            data_MECP.functionData.Lambda = data_MECP.functionData.Lambda + DetParams_Z[3 * workMatrix_ZMatrix.N - 6] * data_MECP.stepSize;
            //更新I
            data_MECP.I++;
            //更新x
