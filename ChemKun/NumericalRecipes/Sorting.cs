...
namespace ChemKun.NumericalRecipes
{
    class Sorting
    {
        /*
        ...
        */
        ...
        public static BnulkVec Piksrt(BnulkVec vec)
        {
            BnulkVec tmpVec = vec;
            int i, j;
            double a;
        ...
        public static void sort2(ref BnulkVec arr, ref BnulkVec brr)
        {
            ...
            for (; ; )                                                                 //当子数组足够小时插入排序
            {
                ...
                else
                {
                    ...
                    if(jstack>=NSTACK)
                    {
                        ChemKun.Output.WriteOutput.Error.Append("NSTACK too small in sort2." + "/n");
